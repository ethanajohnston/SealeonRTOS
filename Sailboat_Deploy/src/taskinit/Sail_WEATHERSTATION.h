...
#define WEATHERSENSOR_MSG_MAX_ARGS 8 
#define PREFIX_LIM 6
#define NUM_MSGS 4


#define MSG_TYPE_TOTAL 10 //sum of all expected msg type ids, eg. 0 + 1 + 2 + 3 = 6.. MAX value = 153 (all types enabled)
#define WS_LOOP_LIM 5000 //max number of loops allowed before weather station task is put to sleep
#define WS_SLEEP_PERIOD_SEC 10	 //length of time in sec that puts weather sensor to sleep
...
static WEATHERSTATION_TYPE_MAP WEATHERSTATION_TYPE_TABLE[WEATHERSENSOR_NUM_MSG_TYPES] = {
	{ eGPGGA, "GPGGA"}, { eGPVTG, "GPVTG"},
	{ eWIMWV, "WIMWV"}, { eYXXDR, "YXXDR"}
